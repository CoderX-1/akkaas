        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <div className="mt-4">
                <h4 className="font-medium">Dubai</h4>
                <a href="mailto:mohammad.zia@theakkaas.com" className="text-blue-600">
                  mohammad.zia@theakkaas.com
                </a>
              </div>
              <div className="mt-4">
                <h4 className="font-medium">Canada</h4>
                <a href="mailto:ali.zaidi@theakkaas.com" className="text-blue-600">
          ...
          <div className="mt-10 flex justify-between flex-col md:flex-row">
            <div className="flex md:flex-row flex-col gap-3 items-center">
              ...
              <div className="flex space-x-2">
                <Link to="/who-we-are" className="text-blue-600">
                  WHO WE ARE
                </Link>
